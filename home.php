<?php get_template_part( 'template-parts/header/header'); ?>
    ...
    <!-- Start Hero Section -->
    <?php get_template_part( 'template-parts/content/content', 'hero', [ 'class' => 'pb200', 'title' => 'Blog', 'description' => 'Welcome to Furni, your number one source for all things furniture.']); ?>
    <!-- End Hero Section -->
