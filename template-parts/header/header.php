<?php
    function get_custom_field($fieldKey) {
        echo acf_get_field($fieldKey)['default_value'];
    }
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="top_row">
                        <div class="left">
                            <div class="phone icon_block">
                                <img src="<?= get_template_directory_uri(); ?>/assets/images/phone_icon.svg" alt="" class="phone_icon">
                                <a href="tel:<?= get_custom_field("field_68fd17734acfa"); ?>"><?= get_custom_field("field_68fd13755d58f"); ?></a>
                            </div>
                            
                            <div class="address icon_block">
                                <img src="<?= get_template_directory_uri(); ?>/assets/images/location_icon.svg" alt="" class="phone_icon">
                                <a href="/contact"><?= get_custom_field("field_68fd13ae5d592"); ?></a>
                            </div>
                        </div>

                        <div class="right">
                            <a class="call_button open-modal-btn" href="#">
                                <span><?= get_custom_field("field_68fd1596d9320"); ?></span>
                                <img src="<?= get_template_directory_uri(); ?>/assets/images/link_arrow.svg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="header_block">
                        ...
                        <div class="header_icons">
                            ...
                            <a href="/favourite" class="header_like header_icon_item">
                            ...
                            <a href="/cart" class="header_basket header_icon_item">
                                <span class="header_counter">1</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                            ...
                            <div class="open-search-modal-btn header_search_icon">
                                <img src="<?= get_template_directory_uri(); ?>/assets/images/header_search_icon.svg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="menu_row">
                        <div class="row_item">
                            ...
                            <div class="left">
                                <div class="phone icon_block">
                                    <img src="<?= get_template_directory_uri(); ?>/assets/images/phone_icon_menu.svg" alt="" class="phone_icon">
                                ...
                                <div class="address icon_block">
                                    <img src="<?= get_template_directory_uri(); ?>/assets/images/location_icon_menu.svg" alt="" class="phone_icon">
